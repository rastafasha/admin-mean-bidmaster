...
export class ProjecttypeService {
  ...
  public projecttype: ProjectType;
      ...
      getProjectTypes() {
        const url = `${baseUrl}/projecttypes/`;
      ...
      getProjectType(_id: string) {
        const url = `${baseUrl}/projecttypes/${_id}`;
        return this.http.get<any>(url, this.headers)
          .pipe(
